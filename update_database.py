...
def process_space_file(file_path, index, model_name, namespace_name):
    try:
...
def main():
    ...
    for space_file in space_files:
        ...
        # Pass the model_name string to the function
        if not process_space_file(file_path, index, model_name, namespace_name):
